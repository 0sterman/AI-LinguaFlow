...
def test_desktop_shortcut_uses_app_name(monkeypatch, tmp_path) -> None:
    ...
    assert startup.desktop_shortcut_path() == tmp_path / "OneDrive" / "Desktop" / "LinguaFlow AI Translator.url"
...
def test_desktop_shortcut_falls_back_to_home_desktop(monkeypatch, tmp_path) -> None:
    ...
    assert startup.desktop_shortcut_path() == tmp_path / "Desktop" / "LinguaFlow AI Translator.url"
